...
= 1.0.6 - 14-05-2023 =
* Added notice for user
* checked PHP compatibility from 7.2-8.2

= 1.0.5 - 11-05-2023 =
* Fixed Font Images issues

= 1.0.4 - 11-05-2023 =
* Fixed 500 error on some server

= 1.0.3 - 10-05-2023 =
* Link Added for custom support
* Redirection error fixed
